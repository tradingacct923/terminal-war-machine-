...
// Panel key → container element ID (needed before boot on line ~2369)
const PANEL_IDS = {
...
// These were originally in app.js — needed here after extraction
const API_URL = "/api/data";
const ANOMALY_URL = "/api/anomalies";
const SETTINGS_URL = "/api/settings";
const VOL_URL = "/api/volatility";
const REFRESH_MS = 30_000;

// Timer handles — declared here (not app.js) because dashboard_charts.js
// loads synchronously while app.js loads with defer.  `let` at file scope
// in a deferred script is NOT global; keeping them here avoids implicit-global bugs.
...
async function updateAnomaly() {
    try {
        ...
        const canvasEl = document.getElementById("chart-anomaly");
        if (!canvasEl) return;   // Canvas not in current layout — skip silently
...
async function updateVolatility() {
    try {
        ...
        if (!document.getElementById('iv-surface')) return;  // Not in current layout
...
// â”€â”€ Macro Economics â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// PANEL_IDS moved to top of file to avoid TDZ
...
// _refreshTimer/_barTimer/_barMs declared at top of file (line ~23)
